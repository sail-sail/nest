...
export class TenantResolver {
  ...
  async findAll(
    ...
    const t = this;
    const data = await t.tenantService.findAll(search, page, sort);
    return data;
  }
  
  @SetMetadata(BACKGROUND_TASK_RESULT, { lbl: "导出租户", type: "download" })
  ...
  async importFile(
    ...
    const t = this;
    const data = await t.tenantService.importFile(id);
    return data;
  }
