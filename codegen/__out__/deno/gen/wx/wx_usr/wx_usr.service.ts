...
export async function findAll(
  ...
  search = search || { };
  const data: WxUsrModel[] = await wx_usrDao.findAll(search, page, sort);
  return data;
}
...
export async function findOne(
  ...
  search = search || { };
  const data = await wx_usrDao.findOne(search, sort);
  return data;
}
...
export async function findById(
  ...
  const data = await wx_usrDao.findById(id);
  return data;
}
...
export async function create(
  ...
  const data = await wx_usrDao.create(input, options);
  return data;
}
...
export async function updateById(
  ...
  const data = await wx_usrDao.updateById(id, input);
  return data;
}
