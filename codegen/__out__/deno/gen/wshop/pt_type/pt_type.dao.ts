...
async function _creates(
  ...
  const args = new QueryArgs();
  let sql = `insert into wshop_pt_type(id,create_time,tenant_id,org_id,create_usr_id,img,lbl,is_home,is_recommend,is_locked,is_enabled,order_by,rem)values`;
...
export async function updateOrgById(
  ...
  const args = new QueryArgs();
  const sql = `update wshop_pt_type set org_id=${ args.push(org_id) } where id=${ args.push(id) }
  `;
