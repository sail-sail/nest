...
async function _creates(
  ...
  const args = new QueryArgs();
  let sql = `insert into base_options(id,create_time,create_usr_id,lbl,ky,val,is_locked,is_enabled,order_by,rem,is_sys)values`;
