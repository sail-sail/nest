...
async function _creates(
  ...
  const args = new QueryArgs();
  let sql = `insert into base_background_task(id,create_time,tenant_id,create_usr_id,create_usr_id_lbl,lbl,state,type,result,err_msg,begin_time,end_time,rem)values`;
