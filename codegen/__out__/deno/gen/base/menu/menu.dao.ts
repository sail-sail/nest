...
async function _creates(
  ...
  const args = new QueryArgs();
  let sql = `insert into base_menu(id,create_time,create_usr_id,create_usr_id_lbl,parent_id,lbl,route_path,route_query,is_locked,is_enabled,order_by,rem)values`;
