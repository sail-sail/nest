...
async function _creates(
  ...
  const args = new QueryArgs();
  let sql = `insert into nuxt_seo(id,create_time,tenant_id,create_usr_id,title,description,keywords,og_image,og_title,og_description,is_locked,is_default,order_by,rem)values`;
