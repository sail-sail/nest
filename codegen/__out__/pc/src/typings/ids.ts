...
/** 企微应用 */
export type WxwAppId = Distinct<string, typeof wxw_appId>;

declare const wxw_app_tokenId: unique symbol;
/** 企微应用接口凭据 */
export type WxwAppTokenId = Distinct<string, typeof wxw_app_tokenId>;

declare const wxw_msgId: unique symbol;
/** 企微消息 */
export type WxwMsgId = Distinct<string, typeof wxw_msgId>;

declare const wxw_usrId: unique symbol;
/** 企微用户 */
export type WxwUsrId = Distinct<string, typeof wxw_usrId>;
