...
const permit = permitStore.getPermit("/wx/wx_app");
...
let exportExcel = $ref(useExportExcel("/wx/wx_app"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wx/wx_app"));
