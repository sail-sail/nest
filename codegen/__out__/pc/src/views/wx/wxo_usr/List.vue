...
const permit = permitStore.getPermit("/wx/wxo_usr");
...
let exportExcel = $ref(useExportExcel("/wx/wxo_usr"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wx/wxo_usr"));
