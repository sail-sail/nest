...
const permit = permitStore.getPermit("/wx/wxo_app");
...
let exportExcel = $ref(useExportExcel("/wx/wxo_app"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wx/wxo_app"));
