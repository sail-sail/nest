  ...
  >
    ...
    >
      ...
      >
        ...
        <template v-if="field_permit('is_home') && (showBuildIn || builtInModel?.is_home == null)">
          <el-form-item
            :label="n('首页显示')"
            prop="is_home"
          >
        ...
        <template v-if="field_permit('is_recommend') && (showBuildIn || builtInModel?.is_recommend == null)">
          <el-form-item
            :label="n('推荐')"
            prop="is_recommend"
          >
