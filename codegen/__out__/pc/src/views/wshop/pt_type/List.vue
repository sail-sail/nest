...
const permit = permitStore.getPermit("/wshop/pt_type");
...
let exportExcel = $ref(useExportExcel("/wshop/pt_type"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wshop/pt_type"));
