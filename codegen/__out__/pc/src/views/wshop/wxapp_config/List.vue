...
const permit = permitStore.getPermit("/wshop/wxapp_config");
...
let exportExcel = $ref(useExportExcel("/wshop/wxapp_config"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wshop/wxapp_config"));
