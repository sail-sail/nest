...
const permit = permitStore.getPermit("/wshop/order");
...
let exportExcel = $ref(useExportExcel("/wshop/order"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wshop/order"));
