...
const permit = permitStore.getPermit("/wshop/pt");
...
let exportExcel = $ref(useExportExcel("/wshop/pt"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wshop/pt"));
