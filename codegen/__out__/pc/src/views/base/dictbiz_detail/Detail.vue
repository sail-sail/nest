...
/** 内置变量 */
let builtInModel = $ref<Dictbiz_DetailInput>();

/** 增加时的默认值 */
async function getDefaultInput() {
  const defaultInput: Dictbiz_DetailInput = {
    order_by: 1,
    is_enabled: 1,
    is_locked: 0,
  };
...
async function showDialog(
  arg?: {
    title?: string;
    builtInModel?: Dictbiz_DetailInput;
    model?: {
      id?: string;
      ids?: string[];
    };
