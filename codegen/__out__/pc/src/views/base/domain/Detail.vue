...
let dialogModel = $ref<DomainInput>({
} as DomainInput);
...
/** 内置变量 */
let builtInModel = $ref<DomainInput>();
...
let findOneModel = findOneDomain;
...
async function save() {
  ...
  if (dialogAction === "add" || dialogAction === "copy") {
    ...
    id = await createDomain(dialogModel2);
    dialogModel.id = id;
    msg = "新增成功";
