  ...
  >
    ...
    >
      ...
      >
        ...
        <template v-if="(showBuildIn || builtInModel?.permit_id == null)">
          <el-form-item
            :label="n('权限')"
            prop="permit_id"
          >
            <CustomSelect
              v-model="dialogModel.permit_id"
...
/** 内置变量 */
let builtInModel = $ref<PermitHistoryInput>();
...
async function getDefaultInput() {
  const defaultInput: PermitHistoryInput = {
    is_visible: 1,
  };
  return defaultInput;
}
...
async function showDialog(
  arg?: {
    title?: string;
    builtInModel?: PermitHistoryInput;
