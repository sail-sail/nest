...
let findOneModel = findOneOptions;
...
async function save() {
  ...
  if (dialogAction === "add" || dialogAction === "copy") {
    ...
    id = await createOptions(dialogModel2);
    dialogModel.id = id;
    msg = "新增成功";
