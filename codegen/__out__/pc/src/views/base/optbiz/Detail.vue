...
/** 内置变量 */
let builtInModel = $ref<OptbizInput>();
...
let findOneModel = findOneOptbiz;
...
async function save() {
  ...
  if (dialogAction === "add" || dialogAction === "copy") {
    ...
    id = await createOptbiz(dialogModel2);
    dialogModel.id = id;
    msg = "新增成功";
