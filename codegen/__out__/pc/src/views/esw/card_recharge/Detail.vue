...
const {
  ...
  initI18ns,
  initSysI18ns,
} = useI18n("/esw/card_recharge");

const permitStore = usePermitStore();

const permit = permitStore.getPermit("/esw/card_recharge");
