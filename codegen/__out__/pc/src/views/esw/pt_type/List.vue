...
const permit = permitStore.getPermit("/esw/pt_type");
...
let exportExcel = $ref(useExportExcel("/esw/pt_type"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/esw/pt_type"));
