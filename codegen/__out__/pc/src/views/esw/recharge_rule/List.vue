...
const permit = permitStore.getPermit("/esw/recharge_rule");
...
let exportExcel = $ref(useExportExcel("/esw/recharge_rule"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/esw/recharge_rule"));
