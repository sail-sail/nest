  ...
  >
    ...
    >
      ...
      >
        ...
        <template v-if="field_permit('job_id') && (showBuildIn || builtInModel?.job_id == null)">
          <el-form-item
            :label="n('任务')"
            prop="job_id"
          >
        ...
        <template v-if="field_permit('cron') && (showBuildIn || builtInModel?.cron == null)">
          <el-form-item
            :label="n('Cron表达式')"
            prop="cron"
          >
        ...
        <template v-if="field_permit('timezone') && (showBuildIn || builtInModel?.timezone == null)">
          <el-form-item
            :label="n('时区')"
            prop="timezone"
          >
