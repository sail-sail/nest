...
pub async fn find_by_id_wx_pay(
  ...
  let wx_pay_model = wx_pay_dao::find_by_id_wx_pay(
    wx_pay_id,
    options,
  ).await?;
...
pub async fn find_by_id_ok_wx_pay(
  ...
  let wx_pay_model = wx_pay_dao::find_by_id_ok_wx_pay(
    wx_pay_id,
    options,
  ).await?;
...
pub async fn find_by_ids_wx_pay(
  ...
  let wx_pay_models = wx_pay_dao::find_by_ids_wx_pay(
    wx_pay_ids,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_wx_pay(
  ...
  let wx_pay_models = wx_pay_dao::find_by_ids_ok_wx_pay(
    wx_pay_ids,
    options,
  ).await?;
...
pub async fn set_id_by_lbl_wx_pay(
  ...
  let wx_pay_input = wx_pay_dao::set_id_by_lbl_wx_pay(
    wx_pay_input,
  ).await?;
...
pub async fn creates_wx_pay(
  ...
  let wx_pay_ids = wx_pay_dao::creates_wx_pay(
    wx_pay_inputs,
    options,
  ).await?;
...
pub async fn update_tenant_by_id_wx_pay(
  ...
  let num = wx_pay_dao::update_tenant_by_id_wx_pay(
    wx_pay_id,
    tenant_id,
    options,
  ).await?;
...
pub async fn validate_option_wx_pay(
  ...
  let wx_pay_model = wx_pay_dao::validate_option_wx_pay(wx_pay_model).await?;
...
pub async fn delete_by_ids_wx_pay(
  ...
  let old_models = wx_pay_dao::find_all_wx_pay(
    Some(WxPaySearch {
  ...
  let num = wx_pay_dao::delete_by_ids_wx_pay(
    wx_pay_ids,
    options,
  ).await?;
...
pub async fn get_is_enabled_by_id_wx_pay(
  ...
  let is_enabled = wx_pay_dao::get_is_enabled_by_id_wx_pay(
    wx_pay_id,
    options,
  ).await?;
...
pub async fn enable_by_ids_wx_pay(
  ...
  let num = wx_pay_dao::enable_by_ids_wx_pay(
    wx_pay_ids,
    is_enabled,
    options,
  ).await?;
...
pub async fn lock_by_ids_wx_pay(
  ...
  let num = wx_pay_dao::lock_by_ids_wx_pay(
    wx_pay_ids,
    is_locked,
    options,
  ).await?;
...
pub async fn get_field_comments_wx_pay(
  ...
  let comments = wx_pay_dao::get_field_comments_wx_pay(
    options,
  ).await?;
...
pub async fn revert_by_ids_wx_pay(
  ...
  let num = wx_pay_dao::revert_by_ids_wx_pay(
    wx_pay_ids,
    options,
  ).await?;
...
pub async fn force_delete_by_ids_wx_pay(
  ...
  let num = wx_pay_dao::force_delete_by_ids_wx_pay(
    wx_pay_ids,
    options,
  ).await?;
