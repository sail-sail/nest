...
pub async fn find_one_ok_wxo_app_token(
  ...
  let model = wxo_app_token_service::find_one_ok_wxo_app_token(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_ok_wxo_app_token(
  ...
  let model = wxo_app_token_service::find_by_id_ok_wxo_app_token(
    id,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_wxo_app_token(
  ...
  let models = wxo_app_token_service::find_by_ids_ok_wxo_app_token(
    ids,
    options,
  ).await?;
...
pub async fn creates_wxo_app_token(
  ...
  use_permit(
    get_page_path_wxo_app_token().to_string(),
    "add".to_owned(),
  ).await?;
