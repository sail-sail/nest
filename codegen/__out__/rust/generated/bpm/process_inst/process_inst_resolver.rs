...
use super::process_inst_service;
...
pub async fn find_all_process_inst(
  ...
  check_sort_process_inst(sort.as_deref())?;
  
  let models = process_inst_service::find_all_process_inst(
    search,
    page,
    sort,
    options,
...
pub async fn find_count_process_inst(
  ...
  let num = process_inst_service::find_count_process_inst(
    search,
    options,
  ).await?;
...
pub async fn find_one_process_inst(
  ...
  let model = process_inst_service::find_one_process_inst(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_one_ok_process_inst(
  ...
  let model = process_inst_service::find_one_ok_process_inst(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_process_inst(
  ...
  let model = process_inst_service::find_by_id_process_inst(
    id,
    options,
  ).await?;
...
pub async fn find_by_id_ok_process_inst(
  ...
  let model = process_inst_service::find_by_id_ok_process_inst(
    id,
    options,
  ).await?;
...
pub async fn find_by_ids_process_inst(
  ...
  let models = process_inst_service::find_by_ids_process_inst(
    ids,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_process_inst(
  ...
  let models = process_inst_service::find_by_ids_ok_process_inst(
    ids,
    options,
  ).await?;
...
pub async fn creates_process_inst(
  ...
  for input in inputs {
    let input = process_inst_service::set_id_by_lbl_process_inst(
      input,
    ).await?;
    inputs2.push(input);
  }
  ...
  use_permit(
    SmolStr::new(get_page_path_process_inst()),
    SmolStr::new("add"),
  ).await?;
  
  let ids = process_inst_service::creates_process_inst(
    inputs,
    options,
  ).await?;
...
pub async fn update_tenant_by_id_process_inst(
  ...
  let num = process_inst_service::update_tenant_by_id_process_inst(
    id,
    tenant_id,
    options,
  ).await?;
...
pub async fn update_by_id_process_inst(
  ...
  let res = process_inst_service::update_by_id_process_inst(
    id,
    input,
    options,
  ).await?;
...
pub async fn delete_by_ids_process_inst(
  ...
  let num = process_inst_service::delete_by_ids_process_inst(
    ids,
    options,
  ).await?;
...
pub async fn get_field_comments_process_inst(
  ...
  let comments = process_inst_service::get_field_comments_process_inst(
    options,
  ).await?;
...
pub async fn revert_by_ids_process_inst(
  ...
  let num = process_inst_service::revert_by_ids_process_inst(
    ids,
    options,
  ).await?;
...
pub async fn force_delete_by_ids_process_inst(
  ...
  let num = process_inst_service::force_delete_by_ids_process_inst(
    ids,
    options,
  ).await?;
