...
pub async fn find_one_ok_cron_job(
  ...
  let model = cron_job_service::find_one_ok_cron_job(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_ok_cron_job(
  ...
  let model = cron_job_service::find_by_id_ok_cron_job(
    id,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_cron_job(
  ...
  let models = cron_job_service::find_by_ids_ok_cron_job(
    ids,
    options,
  ).await?;
...
pub async fn creates_cron_job(
  ...
  use_permit(
    SmolStr::new(get_page_path_cron_job()),
    SmolStr::new("add"),
  ).await?;
...
pub async fn find_last_order_by_cron_job(
  ...
  let order_by = cron_job_service::find_last_order_by_cron_job(
    search,
    options,
  ).await?;
