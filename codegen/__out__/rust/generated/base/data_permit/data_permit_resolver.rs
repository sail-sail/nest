...
pub async fn find_one_ok_data_permit(
  ...
  let model = data_permit_service::find_one_ok_data_permit(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_ok_data_permit(
  ...
  let model = data_permit_service::find_by_id_ok_data_permit(
    id,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_data_permit(
  ...
  let models = data_permit_service::find_by_ids_ok_data_permit(
    ids,
    options,
  ).await?;
