...
pub async fn find_all_server_log(
  ...
  let server_log_models = server_log_dao::find_all_server_log(
    Some(search),
    page,
    sort,
    options,
...
pub async fn find_count_server_log(
  ...
  let server_log_num = server_log_dao::find_count_server_log(
    Some(search),
    options,
  ).await?;
...
pub async fn find_one_server_log(
  ...
  let server_log_model = server_log_dao::find_one_server_log(
    Some(search),
    sort,
    options,
  ).await?;
...
pub async fn find_one_ok_server_log(
  ...
  let server_log_model = server_log_dao::find_one_ok_server_log(
    Some(search),
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_server_log(
  ...
  let server_log_model = server_log_dao::find_by_id_server_log(
    server_log_id,
    options,
  ).await?;
...
pub async fn find_by_id_ok_server_log(
  ...
  let server_log_model = server_log_dao::find_by_id_ok_server_log(
    server_log_id,
    options,
  ).await?;
...
pub async fn find_by_ids_server_log(
  ...
  let server_log_models = server_log_dao::find_by_ids_server_log(
    server_log_ids,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_server_log(
  ...
  let server_log_models = server_log_dao::find_by_ids_ok_server_log(
    server_log_ids,
    options,
  ).await?;
