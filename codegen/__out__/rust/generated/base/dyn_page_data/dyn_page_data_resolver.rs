...
use super::dyn_page_data_service;
...
pub async fn find_all_dyn_page_data(
  ...
  check_sort_dyn_page_data(sort.as_deref())?;
  
  let models = dyn_page_data_service::find_all_dyn_page_data(
    search,
    page,
    sort,
    options,
...
pub async fn find_count_dyn_page_data(
  ...
  let num = dyn_page_data_service::find_count_dyn_page_data(
    search,
    options,
  ).await?;
...
pub async fn find_one_dyn_page_data(
  ...
  let model = dyn_page_data_service::find_one_dyn_page_data(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_one_ok_dyn_page_data(
  ...
  let model = dyn_page_data_service::find_one_ok_dyn_page_data(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_dyn_page_data(
  ...
  let model = dyn_page_data_service::find_by_id_dyn_page_data(
    id,
    options,
  ).await?;
...
pub async fn find_by_id_ok_dyn_page_data(
  ...
  let model = dyn_page_data_service::find_by_id_ok_dyn_page_data(
    id,
    options,
  ).await?;
...
pub async fn find_by_ids_dyn_page_data(
  ...
  let models = dyn_page_data_service::find_by_ids_dyn_page_data(
    ids,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_dyn_page_data(
  ...
  let models = dyn_page_data_service::find_by_ids_ok_dyn_page_data(
    ids,
    options,
  ).await?;
...
pub async fn creates_dyn_page_data(
  ...
  use_permit(
    SmolStr::new(get_page_path_dyn_page_data()),
    SmolStr::new("add"),
  ).await?;
...
pub async fn update_tenant_by_id_dyn_page_data(
  ...
  let num = dyn_page_data_service::update_tenant_by_id_dyn_page_data(
    id,
    tenant_id,
    options,
  ).await?;
