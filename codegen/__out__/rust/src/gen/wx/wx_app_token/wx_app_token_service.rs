...
pub async fn find_all(
  ...
  let wx_app_token_models = wx_app_token_dao::find_all(
    Some(search),
    page,
    sort,
    options,
...
pub async fn find_count(
  ...
  let wx_app_token_num = wx_app_token_dao::find_count(
    Some(search),
    options,
  ).await?;
...
pub async fn find_one(
  ...
  let wx_app_token_model = wx_app_token_dao::find_one(
    Some(search),
    sort,
    options,
  ).await?;
...
pub async fn find_by_id(
  ...
  let wx_app_token_model = wx_app_token_dao::find_by_id(
    wx_app_token_id,
    options,
  ).await?;
...
/// 根据 wx_app_token_ids 查找小程序接口凭据
pub async fn find_by_ids(
  wx_app_token_ids: Vec<WxAppTokenId>,
  options: Option<Options>,
) -> Result<Vec<WxAppTokenModel>> {
  
  let wx_app_token_models = wx_app_token_dao::find_by_ids(
    wx_app_token_ids,
    options,
  ).await?;
...
pub async fn set_id_by_lbl(
  ...
  let wx_app_token_input = wx_app_token_dao::set_id_by_lbl(
    wx_app_token_input,
  ).await?;
...
pub async fn creates(
  ...
  let wx_app_token_ids = wx_app_token_dao::creates(
    wx_app_token_inputs,
    options,
  ).await?;
...
pub async fn update_by_id(
  ...
  let wx_app_token_id = wx_app_token_dao::update_by_id(
    wx_app_token_id,
    wx_app_token_input,
    options.clone(),
  ).await?;
...
pub async fn validate_option(
  ...
  let wx_app_token_model = wx_app_token_dao::validate_option(wx_app_token_model).await?;
...
pub async fn delete_by_ids(
  ...
  let num = wx_app_token_dao::delete_by_ids(
    wx_app_token_ids,
    options,
  ).await?;
...
pub async fn get_field_comments(
  ...
  let comments = wx_app_token_dao::get_field_comments(
    options,
  ).await?;
...
pub async fn revert_by_ids(
  ...
  let num = wx_app_token_dao::revert_by_ids(
    wx_app_token_ids,
    options,
  ).await?;
...
pub async fn force_delete_by_ids(
  ...
  let num = wx_app_token_dao::force_delete_by_ids(
    wx_app_token_ids,
    options,
  ).await?;
