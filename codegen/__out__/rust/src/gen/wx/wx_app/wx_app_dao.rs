...
pub async fn get_field_comments_wx_app(
  ...
  let field_comments = WxAppFieldComment {
    id: "ID".into(),
    code: "原始ID".into(),
    lbl: "名称".into(),
    appid: "开发者ID".into(),
...
pub async fn create_return_wx_app(
  ...
  let model_wx_app = model_wx_app.unwrap();
