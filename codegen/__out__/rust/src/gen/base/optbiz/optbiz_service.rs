...
pub async fn find_all(
  ...
  let optbiz_models = optbiz_dao::find_all(
    Some(search),
    page,
    sort,
    options,
...
pub async fn find_count(
  ...
  let optbiz_num = optbiz_dao::find_count(
    Some(search),
    options,
  ).await?;
...
pub async fn find_one(
  ...
  let optbiz_model = optbiz_dao::find_one(
    Some(search),
    sort,
    options,
  ).await?;
...
pub async fn find_by_id(
  ...
  let optbiz_model = optbiz_dao::find_by_id(
    optbiz_id,
    options,
  ).await?;
...
pub async fn find_by_ids(
  ...
  let optbiz_models = optbiz_dao::find_by_ids(
    optbiz_ids,
    options,
  ).await?;
...
pub async fn set_id_by_lbl(
  ...
  let optbiz_input = optbiz_dao::set_id_by_lbl(
    optbiz_input,
  ).await?;
...
pub async fn validate_option(
  ...
  let optbiz_model = optbiz_dao::validate_option(optbiz_model).await?;
...
pub async fn delete_by_ids(
  ...
  let old_models = optbiz_dao::find_all(
    Some(OptbizSearch {
