...
impl TenantGenQuery {
  ...
  async fn find_all_tenant<'a>(
    ...
    let res = tenant_resolver::find_all(
      &mut ctx,
      search,
      page,
      sort,
  ...
  async fn find_count_tenant<'a>(
    ...
    let res = tenant_resolver::find_count(
      &mut ctx,
      search,
      None,
    ).await;
  ...
  pub async fn find_one_tenant<'a>(
    ...
    let res = tenant_resolver::find_one(
      &mut ctx,
      search,
      sort,
      None,
  ...
  pub async fn find_by_id_tenant<'a>(
    ...
    let res = tenant_resolver::find_by_id(
      &mut ctx,
      id,
      None,
    ).await;
  ...
  /// 根据 ID 查找是否已启用
  /// 记录不存在则返回 false
  pub async fn get_is_enabled_by_id_tenant<'a>(
    &self,
    ctx: &Context<'a>,
    id: String,
  ) -> Result<bool> {
    ...
    let res = tenant_resolver::get_is_enabled_by_id(
      &mut ctx,
      id,
      None,
    ).await;
  ...
  pub async fn get_field_comments_tenant<'a>(
    ...
    let res = tenant_resolver::get_field_comments(
      &mut ctx,
      None,
    ).await;
  ...
  pub async fn find_last_order_by_tenant<'a>(
    ...
    let res = tenant_resolver::find_last_order_by(
      &mut ctx,
      None,
    ).await;
...
impl TenantGenMutation {
  ...
  /// 根据 ids 启用或禁用数据
  pub async fn enable_by_ids_tenant<'a>(
    &self,
    ctx: &Context<'a>,
    ids: Vec<String>,
    is_enabled: u8,
