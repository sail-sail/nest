...
CREATE TABLE `bpm_process_def` (
  ...
  `form_table` varchar(100) NOT NULL DEFAULT '' COMMENT '关联业务表',
...
CREATE TABLE `bpm_process_revision` (
  ...
  `lbl` varchar(100) NOT NULL DEFAULT '' COMMENT '版本标签',
  `graph_json` json DEFAULT NULL COMMENT '流程图JSON',
...
CREATE TABLE `bpm_process_inst` (
  ...
  `form_table` varchar(100) NOT NULL DEFAULT '' COMMENT '业务表名',
