...
CREATE TABLE if not exists `hrm_payslip` (
  ...
  `gross_pay` varchar(66) NOT NULL DEFAULT '' COMMENT '应发工资',
  `social_security` varchar(66) NOT NULL DEFAULT '' COMMENT '代缴社保',
  `individual_tax` varchar(66) NOT NULL DEFAULT '' COMMENT '代缴个税',
  `self_pay` varchar(66) NOT NULL DEFAULT '' COMMENT '个人自付',
  `net_pay` varchar(66) NOT NULL DEFAULT '' COMMENT '实发工资',
