...
static CAN_SORT_IN_API_<#=table.toUpperCase()#>: [&str; <#=can_sort_in_api_props.length.toString()#>] = [<#
...
fn get_can_sort_in_api_<#=table#>() -> &'static [&'static str; <#=can_sort_in_api_props.length.toString()#>] {
  &CAN_SORT_IN_API_<#=table.toUpperCase()#>
}
