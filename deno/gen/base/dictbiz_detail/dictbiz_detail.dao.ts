...
async function _creates(
  ...
  const args = new QueryArgs();
  let sql = `insert into base_dictbiz_detail(id,create_time,tenant_id,create_usr_id,create_usr_id_lbl,dictbiz_id,lbl,val,is_locked,is_enabled,order_by,rem,is_sys)values`;
