...
function getDirectiveLocationForASTPath(
  ...
  switch ((appliedTo as ASTNode).kind) {
    case Kind.OPERATION_DEFINITION:
      // deno-lint-ignore no-explicit-any
      return getDirectiveLocationForOperation((appliedTo as any).operation);
    case Kind.FIELD:
    ...
    case Kind.INPUT_VALUE_DEFINITION: {
      ...
      return (parentNode as ASTNode).kind === Kind.INPUT_OBJECT_TYPE_DEFINITION
    ...
    /* c8 ignore next 2 */
    default:
      false || invariant(false, 'Unexpected kind: ' + inspect((appliedTo as ASTNode).kind));
  }
}
