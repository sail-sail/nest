...
import type { IcombineH5, IcombineNative, IcombineApp, IcombineJsapi, IcloseSubOrders } from './lib/combine_interface.ts';
import type { BatchesTransfer, ProfitSharing } from './lib/interface-v2.ts';
...
class Pay extends Base {
  ...
  public constructor(arg1: Ipay | string, mchid?: string, publicKey?: Uint8Array, privateKey?: Uint8Array, optipns?: Ioptions) {
    ...
    if (arg1 instanceof Object) {
      ...
      this.publicKey = Buffer.from(arg1.publicKey);
      if (!this.publicKey) throw new Error('缺少公钥');
      this.privateKey = Buffer.from(arg1.privateKey);
