...
>
  ...
  >
    ...
    >
      ...
      <template v-if="(showBuildIn == '1' || builtInSearch?.dict_id == null)">
        <el-form-item
          label="系统字典"
          prop="dict_id"
        >
    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- 系统字典 -->
          <template v-if="'dict_id_lbl' === col.prop && (showBuildIn == '1' || builtInSearch?.dict_id == null)">
            <el-table-column
              v-if="col.hide !== true"
              v-bind="col"
            >
...
const props = defineProps<{
  ...
  dict_id_lbl?: string|string[]; // 系统字典
  lbl?: string; // 名称
  lbl_like?: string; // 名称
  val?: string; // 值
  val_like?: string; // 值
...
/** 内置搜索条件 */
const builtInSearch: DictDetailSearch = $computed(() => {
