  ...
  >
    ...
    >
      ...
      >
        ...
        <template v-if="field_permit('domain_ids') && (showBuildIn || builtInModel?.domain_ids == null)">
          <el-form-item
            :label="n('所属域名')"
            prop="domain_ids"
          >
        ...
        <template v-if="field_permit('lang_id') && (showBuildIn || builtInModel?.lang_id == null)">
          <el-form-item
            :label="n('语言')"
            prop="lang_id"
          >
