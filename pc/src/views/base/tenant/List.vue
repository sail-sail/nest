    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- 域名绑定 -->
          <template v-else-if="'host' === col.prop && builtInSearch?.host == null">
            <el-table-column
              v-if="col.hide !== true"
              v-bind="col"
            >
          ...
          <!-- 到期日 -->
          <template v-else-if="'expiration' === col.prop && builtInSearch?.expiration == null">
            <el-table-column
              v-if="col.hide !== true"
              v-bind="col"
            >
          ...
          <!-- 最大用户数 -->
          <template v-else-if="'max_usr_num' === col.prop && builtInSearch?.max_usr_num == null">
            <el-table-column
              v-if="col.hide !== true"
              v-bind="col"
            >
