...
>
  ...
  >
    ...
    >
      ...
      <template v-if="(showBuildIn == '1' || builtInSearch?.dictbiz_id == null)">
        <el-form-item
          label="业务字典"
          prop="dictbiz_id"
        >
    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- 业务字典 -->
          <template v-if="'dictbiz_id_lbl' === col.prop && (showBuildIn == '1' || builtInSearch?.dictbiz_id == null)">
            <el-table-column
              v-if="col.hide !== true"
              v-bind="col"
            >
...
/** 内置搜索条件 */
const builtInSearch: DictbizDetailSearch = $computed(() => {
