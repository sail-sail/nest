...
>
  ...
  >
    ...
    >
      ...
      <template v-if="showBuildIn || builtInSearch?.ky_like == null && builtInSearch?.ky == null">
        <el-form-item
          :label="n('键')"
          prop="ky_like"
        >
...
/** 内置搜索条件 */
const builtInSearch: OptionsSearch = $computed(() => {
  ...
  return Object.fromEntries(entries) as unknown as OptionsSearch;
});
...
const builtInModel = $computed(() => {
  ...
  return Object.fromEntries(entries) as unknown as OptionsModel;
});
