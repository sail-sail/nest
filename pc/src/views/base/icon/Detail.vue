...
/** 内置变量 */
let builtInModel = $ref<IconInput>();
...
async function save() {
  ...
  if (dialogAction === "add" || dialogAction === "copy") {
    ...
    id = await createIcon(dialogModel2);
    dialogModel.id = id;
    msg = "新增成功";
