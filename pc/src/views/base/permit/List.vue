...
>
  ...
  >
    ...
    >
      ...
      <template v-if="builtInSearch?.role_id == null">
        <el-form-item
          label="角色"
          prop="role_id"
        >
    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- 角色 -->
          <template v-if="'role_id_lbl' === col.prop && builtInSearch?.role_id == null">
            <el-table-column
              v-if="col.hide !== true"
              v-bind="col"
            >
          ...
          <!-- 可见 -->
          <template v-else-if="'is_visible' === col.prop && builtInSearch?.is_visible == null">
            <el-table-column
              v-if="col.hide !== true"
              v-bind="col"
            >
