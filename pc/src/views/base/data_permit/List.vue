...
const permit = permitStore.getPermit("/base/data_permit");
...
let exportExcel = $ref(useExportExcel("/base/data_permit"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/base/data_permit"));
