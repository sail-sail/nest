...
let dialogModel = $ref<WxoUsrInput>({
} as WxoUsrInput);
...
/** 内置变量 */
let builtInModel = $ref<WxoUsrInput>();
...
let findOneModel = findOneWxoUsr;
...
async function save() {
  ...
  if (dialogAction === "add" || dialogAction === "copy") {
    ...
    id = await createWxoUsr(dialogModel2);
    dialogModel.id = id;
    msg = "新增成功";
