...
const permit = permitStore.getPermit("/esw/wxapp_config");
...
let exportExcel = $ref(useExportExcel("/esw/wxapp_config"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/esw/wxapp_config"));
