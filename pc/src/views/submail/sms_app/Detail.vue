  ...
  >
    ...
    >
      ...
      >
        ...
        <template v-if="(showBuildIn || builtInModel?.appkey == null)">
          <el-form-item
            label="appkey"
            prop="appkey"
          >
            <CustomInput
              v-model="dialogModel.appkey"
...
let dialogModel = $ref<SmsAppInput>({
} as SmsAppInput);
...
/** 内置变量 */
let builtInModel = $ref<SmsAppInput>();
