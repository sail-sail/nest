...
let exportExcel = $ref(useExportExcel("/wxwork/wxw_usr"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wxwork/wxw_usr"));
...
async function onImportExcel() {
  ...
  const header: { [key: string]: string } = {
    [ await nAsync("企微应用") ]: "wxw_app_id_lbl",
    [ await nAsync("姓名") ]: "lbl",
