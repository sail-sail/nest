...
const permit = permitStore.getPermit("/cron/job");
...
let exportExcel = $ref(useExportExcel("/cron/job"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/cron/job"));
