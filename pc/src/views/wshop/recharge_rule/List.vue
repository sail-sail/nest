...
const permit = permitStore.getPermit("/wshop/recharge_rule");
...
let exportExcel = $ref(useExportExcel("/wshop/recharge_rule"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wshop/recharge_rule"));
