...
import {
  findOneCardRecharge,
  getDefaultInputCardRecharge,
  getPagePathCardRecharge,
  intoInputCardRecharge,
} from "./Api.ts";
...
let findOneModel = findOneCardRecharge;
...
async function showDialog(
  arg?: {
    ...
    findOne?: typeof findOneCardRecharge;
    action: DialogAction;
  },
) {
  inited = false;
  ...
  if (arg?.findOne) {
    ...
    findOneModel = findOneCardRecharge;
  }
...
async function onRefresh() {
  ...
  if (data) {
    dialogModel = intoInputCardRecharge({
      ...data,
    });
  }
