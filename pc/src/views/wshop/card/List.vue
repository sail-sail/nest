...
const permit = permitStore.getPermit("/wshop/card");
...
let exportExcel = $ref(useExportExcel("/wshop/card"));
...
const downloadImportTemplate = $ref(useDownloadImportTemplate("/wshop/card"));
