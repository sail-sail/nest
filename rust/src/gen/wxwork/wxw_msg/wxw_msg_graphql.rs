...
impl WxwMsgGenQuery {
  ...
  /// 获取字段对应的名称
  async fn get_field_comments_wxw_msg<'a>(
    &self,
    ctx: &Context<'a>,
...
impl WxwMsgGenMutation {
  ...
  /// 根据id修改租户id
  async fn update_tenant_by_id_wxw_msg<'a>(
    &self,
    ctx: &Context<'a>,
    id: String,
    tenant_id: String,
  ...
  /// 根据 ids 删除数据
  async fn delete_by_ids_wxw_msg<'a>(
    &self,
    ctx: &Context<'a>,
    ids: Vec<String>,
  ) -> Result<u64> {
  ...
  /// 根据 ids 还原数据
  async fn revert_by_ids_wxw_msg<'a>(
    &self,
    ctx: &Context<'a>,
    ids: Vec<String>,
  ) -> Result<u64> {
  ...
  /// 根据 ids 彻底删除数据
  async fn force_delete_by_ids_wxw_msg<'a>(
    &self,
    ctx: &Context<'a>,
    ids: Vec<String>,
  ) -> Result<u64> {
