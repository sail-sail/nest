...
#[async_graphql::Scalar(name = "CronJobId")]
impl async_graphql::ScalarType for CronJobId {
...
impl From<CronJobId> for ArgType {
...
impl From<CronJobId> for SmolStr {
  fn from(id: CronJobId) -> Self {
    id.0
  }
}

impl From<SmolStr> for CronJobId {
...
impl From<String> for CronJobId {
  fn from(s: String) -> Self {
    Self(s.into())
  }
}

impl From<&str> for CronJobId {
  fn from(s: &str) -> Self {
    Self(s.into())
  }
}

impl Deref for CronJobId {
  type Target = SmolStr;
...
impl Encode<'_, MySql> for CronJobId {
...
impl sqlx::Type<MySql> for CronJobId {
...
impl<'r> sqlx::Decode<'r, MySql> for CronJobId {
  fn decode(
...
impl PartialEq<str> for CronJobId {
