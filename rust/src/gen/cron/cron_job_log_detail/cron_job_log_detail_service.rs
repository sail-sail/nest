...
pub async fn find_all(
  ...
  let cron_job_log_detail_models = cron_job_log_detail_dao::find_all(
    Some(search),
    page,
    sort,
    options,
...
pub async fn find_count(
  ...
  let cron_job_log_detail_num = cron_job_log_detail_dao::find_count(
    Some(search),
    options,
  ).await?;
...
pub async fn find_one(
  ...
  let cron_job_log_detail_model = cron_job_log_detail_dao::find_one(
    Some(search),
    sort,
    options,
  ).await?;
...
pub async fn find_by_id(
  ...
  let cron_job_log_detail_model = cron_job_log_detail_dao::find_by_id(
...
pub async fn find_by_ids(
  ...
  let cron_job_log_detail_models = cron_job_log_detail_dao::find_by_ids(
...
pub async fn set_id_by_lbl(
  ...
  let cron_job_log_detail_input = cron_job_log_detail_dao::set_id_by_lbl(
...
pub async fn validate_option(
  ...
  let cron_job_log_detail_model = cron_job_log_detail_dao::validate_option(cron_job_log_detail_model).await?;
