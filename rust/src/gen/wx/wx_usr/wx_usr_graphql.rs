...
impl WxUsrGenQuery {
  ...
  async fn get_field_comments_wx_usr(
    ...
    Ctx::builder(ctx)
      .build()
      .scope({
        wx_usr_resolver::get_field_comments(
          None,
        )
      }).await
  }
