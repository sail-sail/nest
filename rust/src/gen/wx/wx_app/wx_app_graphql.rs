...
impl WxAppGenQuery {
  ...
  async fn get_is_enabled_by_id_wx_app(
    ...
    Ctx::builder(ctx)
      ...
      .build()
      .scope({
        wx_app_resolver::get_is_enabled_by_id(
          id,
          None,
        )
      }).await
  ...
  async fn get_is_locked_by_id_wx_app(
    ...
    Ctx::builder(ctx)
      ...
      .build()
      .scope({
        wx_app_resolver::get_is_locked_by_id(
          id,
          None,
        )
      }).await
  ...
  async fn get_field_comments_wx_app(
    ...
    Ctx::builder(ctx)
      .build()
      .scope({
        wx_app_resolver::get_field_comments(
          None,
        )
      }).await
  }
  ...
  async fn find_last_order_by_wx_app(
    ...
    Ctx::builder(ctx)
      ...
      .build()
      .scope({
        wx_app_resolver::find_last_order_by(
          None,
        )
      }).await
  }
...
impl WxAppGenMutation {
  ...
  async fn update_tenant_by_id_wx_app(
    ...
    Ctx::builder(ctx)
      ...
      .build()
      .scope({
        wx_app_resolver::update_tenant_by_id(
          id,
          tenant_id,
          None,
        )
  ...
  async fn force_delete_by_ids_wx_app(
    ...
    Ctx::builder(ctx)
      ...
      .build()
      .scope({
        wx_app_resolver::force_delete_by_ids(
          ids,
          None,
        )
      }).await
