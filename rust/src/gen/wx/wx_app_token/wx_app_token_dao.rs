...
use crate::r#gen::wx::wx_app::wx_app_model::WxAppId;
...
pub async fn find_one_ok_wx_app_token(
  ...
  let wx_app_token_model = validate_option_wx_app_token(
...
pub async fn find_by_ids_wx_app_token(
  ...
  let models = find_all_wx_app_token(
    search,
    None,
    None,
    options,
...
pub async fn exists_wx_app_token(
  ...
  let total = find_count_wx_app_token(
    search,
    options,
  ).await?;
...
pub async fn set_id_by_lbl_wx_app_token(
    ...
    && input.wx_app_id.is_none()
  {
    ...
    let model = crate::r#gen::wx::wx_app::wx_app_dao::find_one_wx_app(
      crate::r#gen::wx::wx_app::wx_app_model::WxAppSearch {
  ...
  {
    let wx_app_model = crate::r#gen::wx::wx_app::wx_app_dao::find_one_wx_app(
      crate::r#gen::wx::wx_app::wx_app_model::WxAppSearch {
