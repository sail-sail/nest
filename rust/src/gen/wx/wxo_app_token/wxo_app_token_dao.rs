...
use crate::r#gen::wx::wxo_app::wxo_app_model::WxoAppId;
...
pub async fn exists_wxo_app_token(
  ...
  let total = find_count_wxo_app_token(
    search,
    options,
  ).await?;
...
pub async fn set_id_by_lbl_wxo_app_token(
    ...
    && input.wxo_app_id.is_none()
  {
    ...
    let model = crate::r#gen::wx::wxo_app::wxo_app_dao::find_one_wxo_app(
      crate::r#gen::wx::wxo_app::wxo_app_model::WxoAppSearch {
  ...
  {
    let wxo_app_model = crate::r#gen::wx::wxo_app::wxo_app_dao::find_one_wxo_app(
      crate::r#gen::wx::wxo_app::wxo_app_model::WxoAppSearch {
