...
pub struct GenQuery(
  ...
  crate::gen::base::permit_history::permit_history_graphql::PermitHistoryGenQuery,
...
pub struct GenMutation(
  ...
  crate::gen::base::permit_history::permit_history_graphql::PermitHistoryGenMutation,
