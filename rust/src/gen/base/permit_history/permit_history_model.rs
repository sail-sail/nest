...
pub struct PermitHistoryModel {
  /// ID
  pub id: String,
  /// 权限
  pub permit_id: String,
  /// 权限
  pub permit_id_lbl: String,
  /// 角色
  pub role_id: String,
  /// 角色
...
impl FromRow<'_, MySqlRow> for PermitHistoryModel {
  fn from_row(row: &MySqlRow) -> sqlx::Result<Self> {
    // ID
    let id: String = row.try_get("id")?;
    // 权限
    let permit_id: String = row.try_get("permit_id")?;
    let permit_id_lbl: Option<String> = row.try_get("permit_id_lbl")?;
    let permit_id_lbl = permit_id_lbl.unwrap_or_default();
    // 角色
...
#[graphql(rename_fields = "snake_case")]
pub struct PermitHistoryFieldComment {
  /// 权限
  pub permit_id: String,
  /// 权限
  pub permit_id_lbl: String,
...
#[graphql(rename_fields = "snake_case")]
pub struct PermitHistorySearch {
  ...
  /// 权限
  pub permit_id: Option<Vec<String>>,
  /// 权限
  pub permit_id_is_null: Option<bool>,
  /// 角色
...
#[graphql(rename_fields = "snake_case")]
pub struct PermitHistoryInput {
  pub id: Option<String>,
  /// 权限
  pub permit_id: Option<String>,
  /// 权限
  pub permit_id_lbl: Option<String>,
  /// 角色
...
impl From<PermitHistoryInput> for PermitHistorySearch {
  fn from(input: PermitHistoryInput) -> Self {
    Self {
      ...
      is_deleted: None,
      // 权限
      permit_id: input.permit_id.map(|x| vec![x.into()]),
      // 角色
