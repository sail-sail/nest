...
impl PermitGenQuery {
  ...
  pub async fn find_one_permit<'a>(
    ...
    let res = permit_service::find_one(
      &mut ctx,
      search,
      sort,
      None,
  ...
  pub async fn find_by_id_permit<'a>(
    ...
    let res = permit_service::find_by_id(
      &mut ctx,
      id,
      None,
    ).await;
  ...
  pub async fn get_field_comments_permit<'a>(
    ...
    let res = permit_service::get_field_comments(
      &mut ctx,
      None,
    ).await;
...
impl PermitGenMutation {
  ...
  pub async fn update_tenant_by_id_permit<'a>(
    ...
    let res = permit_service::update_tenant_by_id(
      &mut ctx,
      id,
      tenant_id,
      None,
  ...
  pub async fn delete_by_ids_permit<'a>(
    ...
    let res = permit_service::delete_by_ids(
      &mut ctx,
      ids,
      None,
    ).await;
  ...
  pub async fn revert_by_ids_permit<'a>(
    ...
    let res = permit_service::revert_by_ids(
      &mut ctx,
      ids,
      None,
    ).await;
  ...
  pub async fn force_delete_by_ids_permit<'a>(
    ...
    let res = permit_service::force_delete_by_ids(
      &mut ctx,
      ids,
      None,
    ).await;
