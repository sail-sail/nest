...
pub async fn find_one_ok_wxw_msg(
  ...
  let model = wxw_msg_service::find_one_ok_wxw_msg(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_ok_wxw_msg(
  ...
  let model = wxw_msg_service::find_by_id_ok_wxw_msg(
    id,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_wxw_msg(
  ...
  let models = wxw_msg_service::find_by_ids_ok_wxw_msg(
    ids,
    options,
  ).await?;
...
pub async fn delete_by_ids_wxw_msg(
  ...
  use_permit(
    SmolStr::new(get_page_path_wxw_msg()),
    SmolStr::new("delete"),
  ).await?;
