...
pub async fn find_one_ok_tenant(
  ...
  let model = tenant_service::find_one_ok_tenant(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_by_id_ok_tenant(
  ...
  let model = tenant_service::find_by_id_ok_tenant(
    id,
    options,
  ).await?;
...
pub async fn find_by_ids_ok_tenant(
  ...
  let models = tenant_service::find_by_ids_ok_tenant(
    ids,
    options,
  ).await?;
...
pub async fn creates_tenant(
  ...
  use_permit(
    get_page_path_tenant().to_string(),
    "add".to_owned(),
  ).await?;
