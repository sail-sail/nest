...
use crate::base::dictbiz::dictbiz_model::DictbizId;
...
async fn get_where_query(
  ...
  {
    let ids: Option<Vec<DictbizDetailId>> = match search {
  ...
  // 业务字典
  {
    let dictbiz_id: Option<Vec<DictbizId>> = match search {
      Some(item) => item.dictbiz_id.clone(),
      None => None,
    };
  ...
  }
  {
    ...
    if dictbiz_id_is_null {
      where_query.push_str(" and t.dictbiz_id is null");
    }
  }
  {
  ...
  {
    let dictbiz_id_lbl_like = match search {
      Some(item) => item.dictbiz_id_lbl_like.clone(),
      None => None,
    };
    if let Some(dictbiz_id_lbl_like) = dictbiz_id_lbl_like {
      where_query.push_str(" and dictbiz_id_lbl.lbl like ?");
      args.push(format!("%{}%", sql_like(&dictbiz_id_lbl_like)).into());
    }
  }
  // 名称
  {
...
async fn get_from_query(
  ...
  left join base_dictbiz dictbiz_id_lbl on dictbiz_id_lbl.id=t.dictbiz_id"#.to_owned();
  Ok(from_query)
}
...
pub async fn find_all_dictbiz_detail(
  ...
  // 业务字典
  if let Some(search) = &search && let Some(dictbiz_id) = &search.dictbiz_id {
    let len = dictbiz_id.len();
    if len == 0 {
      return Ok(vec![]);
    }
    if len > ids_limit {
      return Err(eyre!("search.dictbiz_id.length > {ids_limit}"));
    }
  }
  // 启用
...
// MARK: find_count_dictbiz_detail
/// 根据条件查找业务字典明细总数
pub async fn find_count_dictbiz_detail(
  ...
  // 业务字典
  if let Some(search) = &search && search.dictbiz_id.is_some() {
    let len = search.dictbiz_id.as_ref().unwrap().len();
    if len == 0 {
      return Ok(0);
    }
    let ids_limit = options
...
pub async fn find_one_ok_dictbiz_detail(
  ...
  let dictbiz_detail_model = find_one_dictbiz_detail(
    search,
    sort,
    options,
  ).await?;
...
pub async fn find_one_dictbiz_detail(
  ...
  let res = find_all_dictbiz_detail(
    search,
    page,
    sort,
    options,
...
pub async fn find_by_id_ok_dictbiz_detail(
  ...
  let dictbiz_detail_model = find_by_id_dictbiz_detail(
    id,
    options,
  ).await?;
...
// MARK: find_by_ids_ok_dictbiz_detail
...
pub async fn find_by_ids_ok_dictbiz_detail(
  ...
  let dictbiz_detail_models = find_by_ids_dictbiz_detail(
    ids.clone(),
    options,
  ).await?;
  ...
  let dictbiz_detail_models = ids
    .into_iter()
    .map(|id| {
      let model = dictbiz_detail_models
        .iter()
...
// MARK: find_by_ids_dictbiz_detail
/// 根据 ids 查找业务字典明细
#[allow(dead_code)]
...
// MARK: exists_by_id_dictbiz_detail
/// 根据 id 判断业务字典明细是否存在
#[allow(dead_code)]
pub async fn exists_by_id_dictbiz_detail(
  id: DictbizDetailId,
  options: Option<Options>,
) -> Result<bool> {
  ...
  let exists = exists_dictbiz_detail(
    search,
    options,
  ).await?;
...
// MARK: find_by_unique_dictbiz_detail
/// 通过唯一约束获得数据列表
#[allow(unused_variables)]
pub async fn find_by_unique_dictbiz_detail(
...
// MARK: check_by_unique_dictbiz_detail
/// 通过唯一约束检查数据是否已经存在
#[allow(unused_variables)]
pub async fn check_by_unique_dictbiz_detail(
  input: DictbizDetailInput,
  model: DictbizDetailModel,
  options: Option<Options>,
  ...
  if unique_type == UniqueType::Update {
    let id = update_by_id_dictbiz_detail(
      model.id,
      input,
      options,
    ).await?;
...
// MARK: set_id_by_lbl_dictbiz_detail
/// 根据lbl翻译业务字典, 外键关联id, 日期
#[allow(unused_variables, dead_code)]
pub async fn set_id_by_lbl_dictbiz_detail(
  input: DictbizDetailInput,
  ...
  {
    let dictbiz_model = crate::base::dictbiz::dictbiz_dao::find_one_dictbiz(
      crate::base::dictbiz::dictbiz_model::DictbizSearch {
    ...
    if let Some(dictbiz_model) = dictbiz_model {
      input.dictbiz_id_lbl = dictbiz_model.lbl.into();
    }
  }
...
// MARK: creates_return_dictbiz_detail
/// 批量创建业务字典明细并返回
#[allow(dead_code)]
pub async fn creates_return_dictbiz_detail(
  ...
  Ok(models_dictbiz_detail)
}

// MARK: creates_dictbiz_detail
/// 批量创建业务字典明细
...
async fn _creates(
    ...
    .enumerate()
  {
    ...
    let id: DictbizDetailId = get_short_uuid().into();
    ids2.push(id);
...
// MARK: create_return_dictbiz_detail
/// 创建业务字典明细并返回
#[allow(dead_code)]
pub async fn create_return_dictbiz_detail(
  #[allow(unused_mut)]
  ...
  let model_dictbiz_detail = match model_dictbiz_detail {
    Some(model) => model,
    None => {
  ...
  Ok(model_dictbiz_detail)
}

// MARK: create_dictbiz_detail
/// 创建业务字典明细
#[allow(dead_code)]
pub async fn create_dictbiz_detail(
  #[allow(unused_mut)]
  mut input: DictbizDetailInput,
  options: Option<Options>,
...
// MARK: update_tenant_by_id_dictbiz_detail
/// 业务字典明细根据id修改租户id
...
// MARK: sync_usr_lbl_by_usr_id_dictbiz_detail
/// 根据 usr_id 同步创建人/更新人/删除人标签
pub async fn sync_usr_lbl_by_usr_id_dictbiz_detail(
  usr_id: UsrId,
  options: Option<Options>,
) -> Result<u64> {
  let table = get_table_name_dictbiz_detail();
  let method = "sync_usr_lbl_by_usr_id_dictbiz_detail";
...
// MARK: update_by_id_dictbiz_detail
/// 根据 id 修改业务字典明细
#[allow(unused_mut)]
#[allow(unused_variables)]
pub async fn update_by_id_dictbiz_detail(
  ...
  let old_model = match old_model {
    Some(model) => model,
    None => {
      let err_msg = "编辑失败, 此 业务字典明细 已被删除";
      return Err(eyre!(err_msg));
    }
  };
...
// MARK: del_cache_dictbiz_detail
/// 清空缓存
#[allow(dead_code)]
pub async fn del_cache_dictbiz_detail() -> Result<()> {
...
// MARK: delete_by_ids_dictbiz_detail
/// 根据 ids 删除业务字典明细
#[allow(unused_variables)]
...
// MARK: get_is_enabled_by_id_dictbiz_detail
/// 根据 id 查找业务字典明细是否已启用
/// 记录不存在则返回 false
...
// MARK: enable_by_ids_dictbiz_detail
/// 根据 ids 启用或者禁用业务字典明细
...
// MARK: revert_by_ids_dictbiz_detail
/// 根据 ids 还原业务字典明细
pub async fn revert_by_ids_dictbiz_detail(
  ...
  for id in ids.clone() {
    ...
    let mut old_model = find_one_dictbiz_detail(
      DictbizDetailSearch {
        id: Some(id),
        is_deleted: Some(1),
        ..Default::default()
...
// MARK: force_delete_by_ids_dictbiz_detail
/// 根据 ids 彻底删除业务字典明细
#[allow(unused_variables)]
...
// MARK: find_last_order_by_dictbiz_detail
...
// MARK: validate_is_enabled_dictbiz_detail
/// 校验业务字典明细是否启用
#[allow(dead_code)]
pub async fn validate_is_enabled_dictbiz_detail(
  model: &DictbizDetailModel,
) -> Result<()> {
...
// MARK: validate_option_dictbiz_detail
/// 校验业务字典明细是否存在
#[allow(dead_code)]
pub async fn validate_option_dictbiz_detail(
