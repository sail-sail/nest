...
static CAN_SORT_IN_API_DICT_DETAIL: [&str; 3] = [
  "order_by",
  "create_time",
  "update_time",
];
...
impl FromRow<'_, MySqlRow> for DictDetailModel {
  fn from_row(row: &MySqlRow) -> sqlx::Result<Self> {
    ...
    let dict_id_lbl: Option<&str> = row.try_get("dict_id_lbl")?;
    let dict_id_lbl = SmolStr::new(dict_id_lbl.unwrap_or_default());
    // 名称
...
#[graphql(rename_fields = "snake_case", name = "DictDetailFieldComment")]
#[allow(dead_code)]
...
#[graphql(rename_fields = "snake_case", name = "DictDetailSearch")]
#[allow(dead_code)]
pub struct DictDetailSearch {
  ...
  /// 系统字典
  #[graphql(name = "dict_id_lbl")]
  pub dict_id_lbl: Option<Vec<SmolStr>>,
  /// 系统字典
  #[graphql(name = "dict_id_lbl_like")]
  pub dict_id_lbl_like: Option<SmolStr>,
  /// 名称
  #[graphql(name = "lbl")]
...
impl std::fmt::Debug for DictDetailSearch {
  fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    ...
    if let Some(ref dict_id_lbl) = self.dict_id_lbl {
      item = item.field("dict_id_lbl", dict_id_lbl);
    }
    if let Some(ref dict_id_lbl_like) = self.dict_id_lbl_like {
      item = item.field("dict_id_lbl_like", dict_id_lbl_like);
    }
...
pub struct DictDetailInput {
  ...
  /// 系统字典
  #[graphql(name = "dict_id_lbl")]
  pub dict_id_lbl: Option<SmolStr>,
  /// 名称
  #[graphql(name = "lbl")]
  pub lbl: Option<SmolStr>,
  /// 值
...
impl std::fmt::Debug for DictDetailInput {
  fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    let mut item = &mut f.debug_struct("DictDetailInput");
    if let Some(ref id) = self.id {
      item = item.field("id", id);
    }
    if let Some(ref is_deleted) = self.is_deleted {
