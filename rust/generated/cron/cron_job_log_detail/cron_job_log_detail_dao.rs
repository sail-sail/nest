...
// MARK: sync_usr_lbl_by_usr_id_cron_job_log_detail
/// 根据 usr_id 同步创建人/更新人/删除人标签
pub async fn sync_usr_lbl_by_usr_id_cron_job_log_detail(
  usr_id: UsrId,
  options: Option<Options>,
) -> Result<u64> {
  let table = get_table_name_cron_job_log_detail();
  let method = "sync_usr_lbl_by_usr_id_cron_job_log_detail";
