...
static CAN_SORT_IN_API_JOB: OnceLock<[&'static str; 3]> = OnceLock::new();

/// 任务 前端允许排序的字段
fn get_can_sort_in_api_job() -> &'static [&'static str; 3] {
  CAN_SORT_IN_API_JOB.get_or_init(|| [
    "order_by",
    "create_time",
    "update_time",
  ])
...
#[graphql(rename_fields = "snake_case", name = "JobModel")]
#[allow(dead_code)]
pub struct JobModel {
  /// 租户ID
  #[graphql(skip)]
...
impl FromRow<'_, MySqlRow> for JobModel {
...
#[graphql(rename_fields = "snake_case", name = "JobFieldComment")]
#[allow(dead_code)]
pub struct JobFieldComment {
  /// ID
  #[graphql(name = "id")]
  pub id: String,
  /// 编码
...
#[graphql(rename_fields = "snake_case", name = "JobSearch")]
#[allow(dead_code)]
...
impl std::fmt::Debug for JobSearch {
  fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
    let mut item = &mut f.debug_struct("JobSearch");
...
#[graphql(rename_fields = "snake_case", name = "JobInput")]
#[allow(dead_code)]
pub struct JobInput {
  /// ID
  pub id: Option<JobId>,
...
impl From<JobModel> for JobInput {
...
impl From<JobInput> for JobSearch {
...
#[async_graphql::Scalar(name = "JobId")]
impl async_graphql::ScalarType for JobId {
...
impl sqlx::Type<MySql> for JobId {
...
impl<'r> sqlx::Decode<'r, MySql> for JobId {
  fn decode(
...
pub fn check_sort_job(
  ...
  let get_can_sort_in_api_job = get_can_sort_in_api_job();
  ...
  for item in sort {
    ...
    if !get_can_sort_in_api_job.contains(&prop) {
      return Err(eyre!("check_sort_job: {}", serde_json::to_string(item)?));
    }
  }
