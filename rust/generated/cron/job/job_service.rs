...
pub async fn find_by_id_job(
  ...
  let job_model = job_dao::find_by_id_job(
    job_id,
    options,
  ).await?;
...
pub async fn set_id_by_lbl_job(
  ...
  let job_input = job_dao::set_id_by_lbl_job(
    job_input,
  ).await?;
...
pub async fn creates_job(
  ...
  let job_ids = job_dao::creates_job(
    job_inputs,
    options,
  ).await?;
...
pub async fn update_tenant_by_id_job(
  ...
  let num = job_dao::update_tenant_by_id_job(
    job_id,
    tenant_id,
    options,
  ).await?;
...
pub async fn validate_option_job(
  ...
  let job_model = job_dao::validate_option_job(job_model).await?;
...
pub async fn delete_by_ids_job(
  ...
  let old_models = job_dao::find_all_job(
    Some(JobSearch {
  ...
  let num = job_dao::delete_by_ids_job(
    job_ids,
    options,
  ).await?;
...
pub async fn get_is_enabled_by_id_job(
  ...
  let is_enabled = job_dao::get_is_enabled_by_id_job(
    job_id,
    options,
  ).await?;
...
pub async fn enable_by_ids_job(
  ...
  let num = job_dao::enable_by_ids_job(
    job_ids,
    is_enabled,
    options,
  ).await?;
...
pub async fn lock_by_ids_job(
  ...
  let num = job_dao::lock_by_ids_job(
    job_ids,
    is_locked,
    options,
  ).await?;
...
pub async fn get_field_comments_job(
  ...
  let comments = job_dao::get_field_comments_job(
    options,
  ).await?;
...
pub async fn revert_by_ids_job(
  ...
  let num = job_dao::revert_by_ids_job(
    job_ids,
    options,
  ).await?;
...
pub async fn force_delete_by_ids_job(
  ...
  let num = job_dao::force_delete_by_ids_job(
    job_ids,
    options,
  ).await?;
