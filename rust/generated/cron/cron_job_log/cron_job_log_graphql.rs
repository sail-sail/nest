...
impl CronJobLogGenQuery {
  ...
  /// 根据搜索条件和分页查找定时任务日志列表
  #[graphql(name = "findAllCronJobLog")]
  ...
  /// 根据条件查找定时任务日志总数
  #[graphql(name = "findCountCronJobLog")]
  ...
  /// 根据条件查找第一个定时任务日志
  #[graphql(name = "findOneCronJobLog")]
  ...
  #[graphql(name = "findOneOkCronJobLog")]
  ...
  /// 根据 id 查找定时任务日志
  #[graphql(name = "findByIdCronJobLog")]
  ...
  #[graphql(name = "findByIdOkCronJobLog")]
  ...
  /// 根据 id 查找定时任务日志
  #[graphql(name = "findByIdsCronJobLog")]
  ...
  /// 根据 id 查找定时任务日志
  #[graphql(name = "findByIdsOkCronJobLog")]
  ...
  /// 获取定时任务日志字段注释
  #[graphql(name = "getFieldCommentsCronJobLog")]
...
impl CronJobLogGenMutation {
  ...
  #[graphql(name = "noAddNoEditCronJobLog")]
  ...
  /// 定时任务日志根据id修改租户id
  #[graphql(name = "updateTenantByIdCronJobLog")]
  ...
  /// 根据 ids 删除定时任务日志
  #[graphql(name = "deleteByIdsCronJobLog")]
  ...
  /// 根据 ids 还原定时任务日志
  #[graphql(name = "revertByIdsCronJobLog")]
  ...
  /// 根据 ids 彻底删除定时任务日志
  #[graphql(name = "forceDeleteByIdsCronJobLog")]
