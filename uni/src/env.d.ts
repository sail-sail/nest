...
declare namespace UniApp {
  interface Uni {
       ...
       */
      chooseImage(options: ChooseImageOptions): Promise<ChooseImageSuccessCallbackResult>;
      /**
       * 从本地选择文件（仅支持H5）
       *
       ...
       */
      setStorage(options: SetStorageOptions): Promise<{
       ...
       */
      getStorage(options: GetStorageOptions): Promise<{
        data: any;
      }>;
      /**
       ...
       */
      navigateBack(options?: NavigateBackOptions): Promise<{
        errMsg: string;
      }>;
      /**
       * 预加载页面
       ...
       */
      getProvider(options: GetProviderOptions): Promise<GetProviderRes>;
      /**
       * 登录
       *
