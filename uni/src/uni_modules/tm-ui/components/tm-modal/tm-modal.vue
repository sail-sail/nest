<script setup lang="ts">
	...
	const props = defineProps({
		...
		title: {
			type: String,
			default: $i18n.t("tmui32x.tmModal.title"),
		},
		/**
		 * 显示底部操作栏
		 */
	...
	<view>
		...
		<!-- #endif -->
            ...
            _customStyle,
					...
					<view @click.stop="" ref="tmModalWrapContent" class="tmModalWrapContent" :class="[
              status == 'open' ? 'tmModalWrapContent_on' : 'tmModalWrapContent_off',
              ...
              'transition-timing-function': _animationFun,
                    ...
                    -->
									<slot name="title" :show="show">
										<tm-text font-size="34" class="tmModaltitleBoxTitle">{{
                        _title
                    }}</tm-text>
									</slot>
								</view>
							...
							<view v-if="!disabledScroll && _c_height != 'auto'" style="flex: 1"
								class="tmModalWrapBoxContent">
